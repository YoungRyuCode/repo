...
#Constant Variables 
$OutputFile = "C:\Users\Young.Ryu.YRYUSJC-PC2\Nutanix\OneDrive - Nutanix\Application Services\O365\PS_Output\All-DistributionGroupMembers.csv"   #The CSV Output file that is created, change for your purposes 
$arrDLMembers = @{} 
...
{     
	...
	$objDGMembers = Get-DistributionGroupMember -ResultSize Unlimited -Identity $($objDistributionGroup.PrimarySmtpAddress) 
